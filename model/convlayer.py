...
class ResConvBlock2d(nn.Module):
    def __init__(self, conv_block: ConvBlock2D):
        super().__init__()
    ...
    @property
    def in_channels(self):
        return self.conv_block.in_channels

    @property
    def out_channels(self):
        return self.conv_block.out_channels
...
class DownsamplingResBlock(ResBlockBase):
    ...
    def forward(self, x):
        ...
        # the last output channels are extracted using a 1x1 conv layer if strictly necessary ;
